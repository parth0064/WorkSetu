...
import { Phone, MapPin, Mail, Settings, Loader2, Camera } from "lucide-react";
      ...
      <motion.div variants={item} className="glass-card shadow-sm">
        <div className="flex flex-col sm:flex-row gap-6 mb-8 items-center sm:items-start text-center sm:text-left">
          <div className="relative group shrink-0">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-accent to-primary flex items-center justify-center text-4xl shadow-xl border-4 border-background overflow-hidden relative font-black text-white" style={{ fontFamily: "var(--font-heading)" }}>
              {user.profileImage ? (
