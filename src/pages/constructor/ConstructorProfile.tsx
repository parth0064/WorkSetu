    ...
    <motion.div variants={container} initial="hidden" animate="show" className="max-w-3xl space-y-6">
      <motion.div variants={item} className="flex justify-between items-start">
        <div>
          ...
          <p className="text-muted-foreground text-sm font-medium">Manage your agency details and app preferences.</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-6 mb-8 items-center sm:items-start text-center sm:text-left">
          ...
          <div className="flex-1 mt-2">
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mt-4">
              <span className="px-3 py-1 bg-secondary text-foreground text-xs font-bold rounded-lg flex items-center gap-1.5 border border-border/50"><Building size={12} /> Registered Agency</span>
            </div>
          </div>
        </div>
